...
public abstract class AbstractItem implements Serializable {
    ...
    private Collection<ItemUser> itemUsers;
    private Collection<ItemItem> relatedItems;
    private Collection<ItemItem> relatingItems;
    private Collection<ItemTag> itemTags;
    ...
    public void setRelatedItems(Collection<ItemItem> relatedItems) {
    ...
    public void setRelatingItems(Collection<ItemItem> relatingItems) {
        this.relatingItems = relatingItems;
    }

    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name = "item_id")
    public Collection<ItemTag> getItemTags() {
        return itemTags;
    }

    public void setItemTags(Collection<ItemTag> itemTags) {
    ...
    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name = "item_id")
    public Collection<ItemUser> getItemUsers() {
        return itemUsers;
    }

    public void setItemUsers(Collection<ItemUser> itemUsers) {
