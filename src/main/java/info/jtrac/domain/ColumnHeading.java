        ...
        if (isField()) {
            switch (field.getName().getType()) {
                ...
                case 3:
                    ...
                    if (forFragment) {
                        fragment = new Fragment("fragParent", "multiSelect", null);
                        ...
                        JtracCheckBoxMultipleChoice choice = new JtracCheckBoxMultipleChoice("values", new ArrayList(options.keySet()), new IChoiceRenderer() {
                            ...
                            @Override
                            public Object getObject(String s, IModel iModel) {
                                return null;
                            }
                        });
                        fragment.add(choice);
                ...
                case 4: // decimal number
                    ...
                    if (forFragment) {
                        fragment = new Fragment("fragParent", "textField", null);
                ...
                case 6: // date
                    ...
                    list.add(Expression.BETWEEN);
                    if (forFragment) {
                        fragment = new Fragment("fragParent", "dateField", null);
